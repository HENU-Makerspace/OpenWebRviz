...
setup(
    ...
    entry_points={
        'console_scripts':[
            ...
            'stand_test = jetson_node_pkg.stand_test:main',
            'sit_down_test = jetson_node_pkg.sit_down_test:main',
            'stop_test = jetson_node_pkg.stop_test:main',
            'stop_guard = jetson_node_pkg.stop_guard:main',
        ],
    },
)
